 ...
 *
 * Related:
 *   - Schema: repomap-core/plans/punch-card-schema.sql
 *   - Research: repomap-core/docs/research/kilo-cli-server-daemon-integration-2026-02-19.md
 */
...
const daemon = createDaemon({
  ...
  doltPort: parseInt(process.env.DOLT_PORT || "3306", 10),
